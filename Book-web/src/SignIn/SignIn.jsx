...
const SignIn = () => {
  ...
  const [activeForm, setActiveForm] = useState("sign"); // "sign" or "log"

  const handleMoveLeft = () => setActiveForm("log");
  const handleMoveRight = () => setActiveForm("sign");
        ...
        <div className="signin">
          <div
            className={`sign-container ${
              activeForm === "sign" ? "active" : "hidden-right"
            }`}
          >
            ...
            <button className="account-create" onClick={handleSignUp}>
              Create an Account
            </button>
        ...
        <div className="login">
          <div
            className={`log-container ${
              activeForm === "log" ? "active" : "hidden-left"
            }`}
          >
            <h2>Log In</h2>
            <p className="to-login">
            ...
            <button className="account-create" onClick={handleLogin}>
              Log In
            </button>
