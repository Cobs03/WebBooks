...
import data from "../utils/bookSlider.json"; // Make sure the path is correct
import "./Popular.css";

function Popular() {
  const [activeTheme, setActiveTheme] = useState("New & Trending"); // Default active button
  ...
  const handleSearchChange = (e) => {
    ...
    const [activeForm, setActiveForm] = useState("news"); // "sign" or "log"
  
    const handleMoveLeft = () => setActiveForm("mybook");
    const handleMoveRight = () => setActiveForm("news");
      ...
      <div className="theme-section">
        <div className="button-control">
          <button
            ...
            className={activeForm === "mybook" ? "active-button" : ""}
          >
            News & Trending
          </button>
          <button
            onClick={handleMoveRight}
            className={activeForm === "news" ? "active-button" : ""}
          >
            My Books by Genre
          </button>
        </div>
        ...
        <div
          className={`news-container2 ${
            activeForm === "mybook" ? "active" : "hidden-left2"
          }`}
        >
          {data.map((book, index) => (
        ...
        <div
          className={`books-container2 ${
            activeForm === "news" ? "active" : "hidden-left2"
          }`}
        >
          {data.map((book, index) => (
            <div className="book-card" key={index}>
